      ...
      <div className="about-innerContent">
        <div className="article-card row">
          <div className="col">
            ...
            <p className="post-innerContent-content">
            Asking myself often "Who Are You?" and "Are You You?" helped me keep going. These questions come from a mini series I've seen on <a href="https://youtube.com/playlist?list=PLXYEaUHc07uZwOT63py0RTY8CKHOYnMaG" target="_blank">YouTube.</a>
            </p>
